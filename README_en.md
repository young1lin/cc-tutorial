...
│
├── docs/
│   ├── tutorial/                 # Tutorial chapters (11 modules)
...
Curated research from authoritative sources in `docs/research/`:
...
1. **Install Claude Code** - See [Module 01, Chapter 02](docs/tutorial/module-01-fundamentals/chapter-02-setup.md)
2. **Learn the basics** - Start with [Module 01: Fundamentals](docs/tutorial/module-01-fundamentals/)
3. **Practice with examples** - Explore code in [`docs/examples/`](docs/examples/)
4. **Follow video scripts** - Check [`docs/video-scripts/`](docs/video-scripts/) for production outlines
...
- [Tutorial Overview](docs/tutorial/00-tutorial-overview.md)
- [Research Summary](docs/research/00-research-summary.md)
- [Command Cheatsheet](docs/tutorial/module-10-reference/chapter-37-command-cheatsheet.md)
- [Troubleshooting](docs/tutorial/module-10-reference/chapter-38-troubleshooting.md)
