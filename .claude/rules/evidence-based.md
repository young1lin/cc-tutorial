...
### T2 Citations (Expert)
```markdown
Boris Cherny recommends ... ([Best Practices Guide](docs/research/01-xxx.md), 2025-01)
```
...
1. **Search existing research** in `docs/research/` first
2. **If no evidence exists**, either:
   - Find and cite a credible source, save to `docs/research/NN-descriptive-name.md`
...
3. **New research files** must include YAML front matter:
   ...
   ---
   ```
4. **Update** `docs/research/00-research-summary.md` with a summary entry
