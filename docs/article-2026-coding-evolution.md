...
Andrej Karpathy 在 2025 年的技术分享中说过：

> "Prompting is programming. The examples you provide are literally the most information-dense part of your prompt."

你花一百字描述"我要函数式风格、不要可变状态、使用 Option 而不是 null"，还不如直接贴一段你喜欢的代码。代码是最精确的规格说明。
