...
| 序号 | 示例文件 | 内容 | 示例数 | 难度 |
|------|----------|------|--------|------|
| 01 | [01-main.http](docs/examples/http/01-main.http) | 基础功能：Token 演示、对话、流式、Function Calling | 7 | ⭐ |
| 02 | [02-limitations.http](docs/examples/http/02-limitations.http) | LLM 局限性：数学、幻觉、逻辑、知识截止 | 15 | ⭐⭐ |
| 03 | [03-practical-scenarios.http](docs/examples/http/03-practical-scenarios.http) | 实战场景：代码审查、摘要、情感分析、翻译、数据提取 | 18 | ⭐⭐ |
| 04 | [04-function-calling-advanced.http](docs/examples/http/04-function-calling-advanced.http) | 高级工具调用：多工具编排、并行调用、错误处理 | 13 | ⭐⭐⭐ |
| 05 | [05-prompt-engineering.http](docs/examples/http/05-prompt-engineering.http) | 提示词工程：Few-Shot、CoT、结构化输出、角色扮演 | 20 | ⭐⭐ |
| 06 | [06-parameter-experiments.http](docs/examples/http/06-parameter-experiments.http) | 参数调优：Temperature、Top-P、Penalties、模型对比 | 29 | ⭐⭐⭐ |
| 07 | [07-agent-patterns.http](docs/examples/http/07-agent-patterns.http) | Agent 设计模式：ReAct、Plan-and-Execute、Self-Reflection | 9 | ⭐⭐⭐⭐ |
| 08 | [08-legacy-tool-calling.http](docs/examples/http/08-legacy-tool-calling.http) | 传统工具调用：Text ReAct、XML、JSON、Markdown 格式 | 17 | ⭐⭐⭐ |
| 09 | [09-api-protocol-compatibility.http](docs/examples/http/09-api-protocol-compatibility.http) | 协议兼容：OpenAI 格式 vs Anthropic 格式 | 5 | ⭐⭐ |
| | **合计** | | **128+** | |
...
> **动手练习** → [01-main.http](docs/examples/http/01-main.http)：第一个请求展示了"字数不等于 Token"的概念
...
> **动手练习** → [02-limitations.http](docs/examples/http/02-limitations.http)：15 个局限性演示，覆盖 5 大类问题
...
> **动手练习** → [02-limitations.http](docs/examples/http/02-limitations.http)：
...
> **动手练习** → [02-limitations.http](docs/examples/http/02-limitations.http)：知识截止测试 + 工具调用实时信息
...
> **动手练习** → [02-limitations.http](docs/examples/http/02-limitations.http)：城市列表位置回忆测试
...
> **动手练习** → [03-practical-scenarios.http](docs/examples/http/03-practical-scenarios.http)：18 个实战场景，覆盖 6 大类
...
> **动手练习** → [03-practical-scenarios.http](docs/examples/http/03-practical-scenarios.http)：
...
> **动手练习** → [01-main.http](docs/examples/http/01-main.http)：
...
> **动手练习** → [04-function-calling-advanced.http](docs/examples/http/04-function-calling-advanced.http)：13 个高级示例
...
> **动手练习** → [08-legacy-tool-calling.http](docs/examples/http/08-legacy-tool-calling.http)：17 个示例，覆盖 4 种传统格式
...
> **动手练习** → [09-api-protocol-compatibility.http](docs/examples/http/09-api-protocol-compatibility.http)：5 个协议对比示例
...
> **延伸阅读**：想深入理解 Function Calling → MCP 的完整实现？看这个项目：[minimal-mcp](https://github.com/young1lin/minimal-mcp)
...
> **动手练习** → [05-prompt-engineering.http](docs/examples/http/05-prompt-engineering.http)：20 个示例，覆盖 6 大技术
...
> **动手练习** → [05-prompt-engineering.http](docs/examples/http/05-prompt-engineering.http)：
...
> **动手练习** → [05-prompt-engineering.http](docs/examples/http/05-prompt-engineering.http)：客服风格学习示例
...
> **动手练习** → [06-parameter-experiments.http](docs/examples/http/06-parameter-experiments.http)：29 个参数实验，覆盖 7 大参数
...
> **动手练习** → [06-parameter-experiments.http](docs/examples/http/06-parameter-experiments.http)：
...
> **动手练习** → [07-agent-patterns.http](docs/examples/http/07-agent-patterns.http)：9 个 Agent 模式示例
...
> **动手练习** → [07-agent-patterns.http](docs/examples/http/07-agent-patterns.http)：
...
| Claude Code 入门 | DeepLearning.AI | Claude Code 实战（Elie Schoppik 授课） | 见 docs/research/03 |
...
| 文件 | 内容 |
|------|------|
| [docs/research/00-research-summary.md](docs/research/00-research-summary.md) | 全部研究材料汇总 |
| [docs/research/01-claude-code-best-practices-anthropic-official.md](docs/research/01-claude-code-best-practices-anthropic-official.md) | Boris Cherny 最佳实践（T1） |
| [docs/research/03-andrew-ng-course-outline.md](docs/research/03-andrew-ng-course-outline.md) | Andrew Ng 课程大纲 |
| [docs/research/04-addy-osmani-2026-workflow.md](docs/research/04-addy-osmani-2026-workflow.md) | Addy Osmani 2026 工作流 |
| [docs/examples/http/](docs/examples/http/) | 128+ 可执行 HTTP 示例 |
