...
**[Tutorial perspective]** 不要用 MiniMax M2.1 写代码。虽然宣称 200K 上下文，但实测中它的代码生成质量不稳定，长距离依赖处理差，输出的代码经常是一坨烂泥。MiniMax 官方博客已确认 M2 最终采用 Full Attention（详见 [Why Did M2 End Up as a Full Attention Model?](https://www.minimax.io/news/why-did-m2-end-up-as-a-full-attention-model)）。
