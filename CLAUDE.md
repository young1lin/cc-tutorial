...
```markdown
Boris Cherny recommends ... ([Best Practices Guide](docs/research/01-claude-code-best-practices-anthropic-official.md), 2025-01)
```
...
1. Save to `docs/research/NN-descriptive-name.md` (increment NN from the last file)
2. Include YAML front matter at the top of the file:
   ...
   ---
   ```
3. Update `docs/research/00-research-summary.md` with a summary entry
